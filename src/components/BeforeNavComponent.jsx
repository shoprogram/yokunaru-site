    ...
    <div>
      <article className={ Styles.navContainer}>
        <section className={ Styles.topNavContaints}>
          ...
          <a  className={ Styles.news }  onClick={() => dispatch(push("/"))} ></a>
          <a  className={ Styles.trend } onClick={() => dispatch(push("/comingSoon"))} ></a>
          <a className={ Styles.timeLine } onClick={() => dispatch(push("/comingSoon"))} ></a>
        </section>
